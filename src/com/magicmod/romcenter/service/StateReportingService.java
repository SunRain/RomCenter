...
package com.magicmod.romcenter.service;
...
public class StateReportingService extends Service {
    private static final String TAG = "StateReportingService";
    ...
    private class StatsUploadTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            final Context context = StateReportingService.this;
            String deviceId = UtilTools.getUniqueID(context);
            String deviceName = UtilTools.getDevice();
            String deviceVersion = UtilTools.getModVersion();
            String deviceCountry = UtilTools.getCountryCode(context);
            String deviceCarrier = UtilTools.getCarrier(context);
            String deviceCarrierId = UtilTools.getCarrierId(context);
            
            String romName = UtilTools.getRomName();
            String romVersion = UtilTools.getRomVersion();
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                final SharedPreferences prefs = RomStateFragment.getPreferences(context);
                prefs.edit().putLong(Constants.ANONYMOUS_LAST_CHECKED,
            ...
            StateReportingServiceReceiver.setAlarm(context, interval);
            stopSelf();
        }
    }
}
